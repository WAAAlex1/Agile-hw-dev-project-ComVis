...
/** SevenSegDecoder - Combinatorial digit extraction and percentage calculation
  *
  * Takes raw confidence score and converts to displayable BCD digits. Layout: [7]=digitA, [5]=digitB,
  * [2][1][0]=percentage
  *
  * @param maxScore
  *   Theoretical maximum score (imgWidth x templates) - computed at elaboration
  */
