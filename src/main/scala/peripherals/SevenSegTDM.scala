 ...
 *
 * Implements TDM for Nexys A7 board with active-low anode and cathode signals.
 * Refresh rate: Clock frequency / refreshDiv / 8 digits
 *
...
class SevenSegTDM(val refreshDiv: Int = 100000) extends Module {
  ...
  val segmentPatterns = VecInit(Seq(
