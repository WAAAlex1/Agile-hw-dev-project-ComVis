...
module MultiTemplateBram(	// \\src\\main\\scala\\bram\\bramMem.scala:174:7
  ...
  input  [11:0] io_memWrite_wrAddr,	// \\src\\main\\scala\\bram\\bramMem.scala:193:14
...
module TopModuleComVis(	// \\src\\main\\scala\\comvis\\TopModuleComVis.scala:7:7
  ...
  MultiTemplateBram bram (	// \\src\\main\\scala\\comvis\\TopModuleComVis.scala:46:20
    ...
    .io_memWrite_wrAddr         (io_memWrite_wrAddr),
...
module Rx(	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
  input        clock,	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
               reset,	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
               io_rxd,	// \\src\\main\\scala\\peripherals\\Rx.scala:11:14
               io_channel_ready,	// \\src\\main\\scala\\peripherals\\Rx.scala:11:14
  output       io_channel_valid,	// \\src\\main\\scala\\peripherals\\Rx.scala:11:14
  output [7:0] io_channel_bits	// \\src\\main\\scala\\peripherals\\Rx.scala:11:14
);

  reg        rxReg_REG;	// \\src\\main\\scala\\peripherals\\Rx.scala:19:32
  reg        rxReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:19:24
  reg        falling_REG;	// \\src\\main\\scala\\peripherals\\Rx.scala:20:35
  reg [7:0]  shiftReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:22:25
  reg [19:0] cntReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25
  reg [3:0]  bitsReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:24:25
  reg        valReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:25:25
  always @(posedge clock) begin	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
    if (reset) begin	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      rxReg_REG <= 1'h0;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32
      rxReg <= 1'h0;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:24
      shiftReg <= 8'h0;	// \\src\\main\\scala\\peripherals\\Rx.scala:22:25
      cntReg <= 20'h1B1;	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25
      bitsReg <= 4'h0;	// \\src\\main\\scala\\peripherals\\Rx.scala:24:25
      valReg <= 1'h0;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :25:25
    end
    else begin	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      rxReg_REG <= io_rxd;	// \\src\\main\\scala\\peripherals\\Rx.scala:19:32
      rxReg <= rxReg_REG;	// \\src\\main\\scala\\peripherals\\Rx.scala:19:{24,32}
      if ((|cntReg) | ~(|bitsReg)) begin	// \\src\\main\\scala\\peripherals\\Rx.scala:22:25, :23:25, :24:25, :27:{15,24}, :29:{22,31}
      end
      else	// \\src\\main\\scala\\peripherals\\Rx.scala:22:25, :27:24, :29:31
        shiftReg <= {rxReg, shiftReg[7:1]};	// \\src\\main\\scala\\peripherals\\Rx.scala:19:24, :22:25, :31:{20,37}
      if (|cntReg)	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25, :27:15
        cntReg <= cntReg - 20'h1;	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25, :28:22
      else if (|bitsReg) begin	// \\src\\main\\scala\\peripherals\\Rx.scala:24:25, :29:22
        cntReg <= 20'h1B1;	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25
        bitsReg <= bitsReg - 4'h1;	// \\src\\main\\scala\\peripherals\\Rx.scala:24:25, :32:25
      end
      else if (~rxReg & falling_REG) begin	// \\src\\main\\scala\\peripherals\\Rx.scala:19:24, :20:{17,24,35}
        cntReg <= 20'h289;	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25, :38:13
        bitsReg <= 4'h8;	// \\src\\main\\scala\\peripherals\\Rx.scala:24:25, :39:13
      end
      valReg <=
        ~(valReg & io_channel_ready)
        & (~(|cntReg) & (|bitsReg) & bitsReg == 4'h1 | valReg);	// \\src\\main\\scala\\peripherals\\Rx.scala:23:25, :24:25, :25:25, :27:{15,24}, :29:{22,31}, :34:18, :41:{15,36}, :42:12
    end
    falling_REG <= rxReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:19:24, :20:35
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
    `ifdef FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      `FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      automatic logic [31:0] _RANDOM[0:1];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      `ifdef INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
        `INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
        end	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
        rxReg_REG = _RANDOM[1'h0][0];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32
        rxReg = _RANDOM[1'h0][1];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:{24,32}
        falling_REG = _RANDOM[1'h0][2];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32, :20:35
        shiftReg = _RANDOM[1'h0][10:3];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32, :22:25
        cntReg = _RANDOM[1'h0][30:11];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32, :23:25
        bitsReg = {_RANDOM[1'h0][31], _RANDOM[1'h1][2:0]};	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :19:32, :24:25
        valReg = _RANDOM[1'h1][3];	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :24:25, :25:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
      `FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_channel_valid = valReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :25:25
  assign io_channel_bits = shiftReg;	// \\src\\main\\scala\\peripherals\\Rx.scala:10:7, :22:25
endmodule

module BootBuffer(	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
  input         clock,	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
                reset,	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
                io_saveCtrl,	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:11:14
  input  [7:0]  io_dataIn,	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:11:14
  output [63:0] io_dataOut	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:11:14
);

  reg [63:0] buffer;	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:17:23
  always @(posedge clock) begin	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
    if (reset)	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      buffer <= 64'h0;	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:17:23
    else if (io_saveCtrl)	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:11:14
      buffer <= {io_dataIn, buffer[63:8]};	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:17:23, :21:{25,34}
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
    `ifdef FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      `FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      automatic logic [31:0] _RANDOM[0:1];	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      `ifdef INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
        `INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
        end	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
        buffer = {_RANDOM[1'h0], _RANDOM[1'h1]};	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7, :17:23
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
      `FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_dataOut = buffer;	// \\src\\main\\scala\\peripherals\\BootBuffer.scala:10:7, :17:23
endmodule

module Bootloader(	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
  input         clock,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
                reset,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
  output [31:0] io_wrData,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:16:14
                io_wrAddr,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:16:14
  output        io_wrEn,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:16:14
  input         io_rx,	// \\src\\main\\scala\\peripherals\\Bootloader.scala:16:14
                io_sleep	// \\src\\main\\scala\\peripherals\\Bootloader.scala:16:14
);

  wire [63:0] _buffer_io_dataOut;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:25:22
  wire        _rx_io_channel_valid;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:24:22
  wire [7:0]  _rx_io_channel_bits;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:24:22
  reg         stateReg;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:31:25
  reg         incr;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:33:26
  reg         save;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:34:26
  reg         wrEnabled;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:35:26
  reg  [3:0]  byteCount;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:36:26
  wire        _GEN = byteCount == 4'h8;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:36:26, :64:28
  wire        _GEN_0 = ~stateReg & ~stateReg & ~(io_sleep | _GEN) & _rx_io_channel_valid;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:24:22, :31:25, :48:23, :50:23, :53:20, :62:22, :64:{28,37}, :68:39
  always @(posedge clock) begin	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
    if (reset) begin	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      stateReg <= 1'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25
      incr <= 1'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :33:26
      save <= 1'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :34:26
      wrEnabled <= 1'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :35:26
      byteCount <= 4'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:36:26
    end
    else begin	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      stateReg <= io_sleep;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:31:25
      incr <= _GEN_0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:33:26, :48:23, :53:20
      save <= _GEN_0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:34:26, :48:23, :53:20
      wrEnabled <= ~stateReg & ~stateReg & ~io_sleep & _GEN;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:31:25, :35:26, :50:23, :53:20, :62:22, :64:{28,37}
      if (stateReg | io_sleep | ~_GEN) begin	// \\src\\main\\scala\\peripherals\\Bootloader.scala:31:25, :38:22, :53:20, :62:22, :64:{28,37}
        if (incr)	// \\src\\main\\scala\\peripherals\\Bootloader.scala:33:26
          byteCount <= byteCount + 4'h1;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:36:26, :39:28
      end
      else	// \\src\\main\\scala\\peripherals\\Bootloader.scala:38:22, :53:20
        byteCount <= 4'h0;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:36:26
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
    `ifdef FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      `FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      automatic logic [31:0] _RANDOM[0:0];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      `ifdef INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
        `INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
        stateReg = _RANDOM[/*Zero width*/ 1'b0][0];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25
        incr = _RANDOM[/*Zero width*/ 1'b0][1];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25, :33:26
        save = _RANDOM[/*Zero width*/ 1'b0][2];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25, :34:26
        wrEnabled = _RANDOM[/*Zero width*/ 1'b0][3];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25, :35:26
        byteCount = _RANDOM[/*Zero width*/ 1'b0][7:4];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :31:25, :36:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
      `FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  Rx rx (	// \\src\\main\\scala\\peripherals\\Bootloader.scala:24:22
    .clock            (clock),
    .reset            (reset),
    .io_rxd           (io_rx),
    .io_channel_ready (_GEN_0),	// \\src\\main\\scala\\peripherals\\Bootloader.scala:48:23, :53:20
    .io_channel_valid (_rx_io_channel_valid),
    .io_channel_bits  (_rx_io_channel_bits)
  );
  BootBuffer buffer (	// \\src\\main\\scala\\peripherals\\Bootloader.scala:25:22
    .clock       (clock),
    .reset       (reset),
    .io_saveCtrl (save),	// \\src\\main\\scala\\peripherals\\Bootloader.scala:34:26
    .io_dataIn   (_rx_io_channel_bits),	// \\src\\main\\scala\\peripherals\\Bootloader.scala:24:22
    .io_dataOut  (_buffer_io_dataOut)
  );
  assign io_wrData = _buffer_io_dataOut[63:32];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :25:22, :81:33
  assign io_wrAddr = _buffer_io_dataOut[31:0];	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :25:22, :82:33
  assign io_wrEn = wrEnabled;	// \\src\\main\\scala\\peripherals\\Bootloader.scala:15:7, :35:26
endmodule
...
module SevenSegDecoder(	// \\src\\main\\scala\\peripherals\\SevenSegDecoder.scala:14:7
  ...
  input  [3:0]  io_digitB,	// \\src\\main\\scala\\peripherals\\SevenSegDecoder.scala:19:14
...
module SevenSegTDM(	// \\src\\main\\scala\\peripherals\\SevenSegTDM.scala:14:7
  ...
  wire [7:0][3:0]  _GEN =
    {{4'h0}, {4'hF}, {io_digits_5}, {4'hF}, {4'hF}, {4'hF}, {io_digits_1}, {io_digits_0}};	// \\src\\main\\scala\\peripherals\\SevenSegTDM.scala:17:14, :81:28
  ...
  wire [15:0][7:0] _GEN_2 =
    {{_GEN_1 & (&_GEN_0) ? 8'hFF : 8'h8E},
     ...
     {_GEN_1 & _GEN_0 == 4'h0 ? 8'hFF : 8'hC0}};	// \\src\\main\\scala\\peripherals\\SevenSegTDM.scala:17:14, :55:32, :80:24, :81:28, :82:28, :87:15
...
module SevenSegDriver(	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:16:7
  ...
  input  [3:0]  io_digitB,	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:20:14
  ...
  `ifndef SYNTHESIS	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:48:9
    always @(posedge clock) begin	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:48:9
      if (~reset & io_digitB > 4'h9) begin	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:48:{9,20}
      ...
      if (~reset & io_confidence > 14'h2800) begin	// \\src\\main\\scala\\peripherals\\SevenSegDriver.scala:48:9, :49:{9,24}
...
module TopWrapperUART(	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
  input        clock,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
               reset,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
               io_start,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
               io_rx,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
  output [7:0] io_led,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
  output       io_done,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
  output [7:0] io_anodes,	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
               io_cathodes	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:19:14
);

  wire        _startSignal_debouncer_io_stable;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:49:27
  wire [31:0] _bootloader_io_wrData;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26
  wire [31:0] _bootloader_io_wrAddr;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26
  wire        _bootloader_io_wrEn;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26
  wire        _comVis_io_done;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22
  wire [3:0]  _comVis_io_bestIdx;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22
  wire [13:0] _comVis_io_bestConf;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22
  reg  [7:0]  ledReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:58:23
  reg         doneReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:59:24
  reg  [3:0]  bestIdxReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:60:27
  reg  [13:0] bestConfReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:61:28
  wire        _GEN = _bootloader_io_wrAddr == 32'hF0010000;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :87:31
  wire        _GEN_0 = _bootloader_io_wrAddr == 32'hF1000000;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :94:31
  always @(posedge clock) begin	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
    if (reset) begin	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      ledReg <= 8'h0;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:58:23
      doneReg <= 1'h0;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :59:24
      bestIdxReg <= 4'h0;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:60:27
      bestConfReg <= 14'h0;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:61:28
    end
    else begin	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      if (_bootloader_io_wrEn & _GEN)	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :58:23, :85:36, :87:{31,50}, :90:31
        ledReg <= _bootloader_io_wrData[7:0];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :58:23, :90:54
      if (_comVis_io_done) begin	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22
        doneReg <= _comVis_io_done;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22, :59:24
        bestIdxReg <= _comVis_io_bestIdx;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22, :60:27
        bestConfReg <= _comVis_io_bestConf;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22, :61:28
      end
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
    `ifdef FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      `FIRRTL_BEFORE_INITIAL	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      automatic logic [31:0] _RANDOM[0:0];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      `ifdef INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
        `INIT_RANDOM_PROLOG_	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
        ledReg = _RANDOM[/*Zero width*/ 1'b0][7:0];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :58:23
        doneReg = _RANDOM[/*Zero width*/ 1'b0][8];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :58:23, :59:24
        bestIdxReg = _RANDOM[/*Zero width*/ 1'b0][12:9];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :58:23, :60:27
        bestConfReg = _RANDOM[/*Zero width*/ 1'b0][26:13];	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :58:23, :61:28
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
      `FIRRTL_AFTER_INITIAL	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  TopModuleComVis comVis (	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:39:22
    .clock              (clock),
    .reset              (reset),
    .io_start           (_startSignal_debouncer_io_stable),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:49:27
    .io_memWrite_wrEn   (~(_bootloader_io_wrEn & (_GEN_0 | _GEN)) & _bootloader_io_wrEn),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :75:29, :85:36, :87:{31,50}, :89:31, :94:{31,50}, :96:31
    .io_memWrite_wrAddr (_bootloader_io_wrAddr[11:0]),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :74:{29,52}
    .io_memWrite_wrData (_bootloader_io_wrData),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26
    .io_done            (_comVis_io_done),
    .io_bestIdx         (_comVis_io_bestIdx),
    .io_bestConf        (_comVis_io_bestConf)
  );
  Bootloader bootloader (	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26
    .clock     (clock),
    .reset     (reset),
    .io_wrData (_bootloader_io_wrData),
    .io_wrAddr (_bootloader_io_wrAddr),
    .io_wrEn   (_bootloader_io_wrEn),
    .io_rx     (io_rx),
    .io_sleep  (_bootloader_io_wrEn & _GEN_0 & _bootloader_io_wrData[0])	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:42:26, :77:29, :85:36, :94:{31,50}, :97:{31,54}
  );
  SevenSegDriver sevenSegDriver (	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:46:30
    .clock         (clock),
    .reset         (reset),
    .io_digitB     (bestIdxReg),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:60:27
    .io_confidence (bestConfReg),	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:61:28
    .io_anodes     (io_anodes),
    .io_cathodes   (io_cathodes)
  );
  Debounce startSignal_debouncer (	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:49:27
    .clock     (clock),
    .reset     (reset),
    .io_btn    (io_start),
    .io_stable (_startSignal_debouncer_io_stable)
  );
  assign io_led = ledReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :58:23
  assign io_done = doneReg;	// \\src\\main\\scala\\topLevel\\TopWrapperUART.scala:9:7, :59:24
endmodule
